...
const projects = [
  ...
  },
  {
    ...
    description: 'An IoT-enabled smart home automation system built for accessible and independent living, featuring fall detection, motion sensing, temperature alerts, and smart lighting powered by ESP32, MPU6050, PIR, and DHT22 sensors.',
    ...
    technologies: ['React', 'Node.js', 'Express.js', 'Firebase', 'Tailwind CSS', 'MediaPipe', 'Socket.IO', 'Web Speech API', 'Chart.js', 'ESP32', 'MPU6050', 'PIR Sensor', 'DHT22'],
  ...
  },
  {
    ...
    description: 'HR-GenAI is an AI-powered hiring intelligence platform that automates candidate evaluation, conducts AI interviews, and creates Digital DNA Profiles to predict job performance and cultural fit with 95% accuracy.',
    ...
    technologies: ['React', 'Node.js', 'Firebase', 'MongoDB', 'OpenAI', 'PDFKit', 'Nodemailer', 'Web Speech API', 'Tailwind CSS', 'Google Gemini'],
  ...
  },
  {
    ...
    technologies: ['React', 'Node.js', 'Express.js', 'C++', 'Framer Motion', 'Tailwind CSS', 'JavaScript', 'HTML'],
  ...
  },
  {
    ...
    description: 'India\'s First AI-Powered Content Moderation for Digital India | 87% Accuracy | 12 Models | 9 Languages | Real-Time Threat Detection | Court-Ready Evidence | IPC/IT Act Compliance | Built for NITI Aayog',
    ...
    technologies: ['React', 'FastAPI', 'Python', 'PyTorch', 'MongoDB', 'OpenCV', 'HuggingFace', 'EasyOCR', 'JavaScript', 'CSS'],
  ...
  },
  {
    ...
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'MySQL', 'Node.js'],
  ...
  },
  {
    ...
    technologies: ['React', 'Vite', 'Tailwind CSS', 'Firebase', 'Framer Motion', 'TypeScript', 'AOS', 'Material UI', 'Local Storage'],
  ...
  },
  {
    ...
    technologies: ['HTML5', 'CSS3', 'JavaScript', 'Three.js', 'WebGL', 'GSAP', 'Draco'],
