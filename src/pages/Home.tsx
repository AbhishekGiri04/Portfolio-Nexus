            ...
            {[1, 2, 3].map((num) => (
              <div key={num} className="relative group overflow-hidden rounded-2xl shadow-lg">
                <img 
                  ...
                  alt={`Photo ${num}`} 
                  className={`w-full h-80 object-cover ${num === 1 ? 'object-[center_40%] scale-125' : num === 3 ? 'object-[center_20%]' : 'object-top'} group-hover:scale-105 transition-transform duration-300`}
                />
